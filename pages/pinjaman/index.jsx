              ...
              <form>
                <div className="card-body">
                  ...
                  <div className="form-check">
                    ...
                    <label className="form-check-label" for="exampleCheck1">Form yang saya isi sudah saya pastikan sebenar-benarnya,
